...
export default function Home() {
  ...
  const heroImage =
    '/manus-storage/714184576_122100606669347192_2241053203693255898_n_425ab5f6.jpg';
  const featuredImage =
    '/manus-storage/712623579_122100606657347192_4874021295777789728_n_3d670ba7.jpg';
        ...
        <div className="container max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <ProductCard
              ...
              image="/manus-storage/710299364_122098655451347192_8853350640011998274_n_aab259e9.jpg"
              price="₱25 each"
            />
            <ProductCard
              name="Midnight Cloud"
              description="Deep, chocolatey goodness with a perfectly crackly top."
              image="/manus-storage/711135976_122098655463347192_8560571763386060133_n_77aa0731.jpg"
              price="₱35 each"
            />
            <ProductCard
